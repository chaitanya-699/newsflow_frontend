...
export default function SearchPage() {
  return (
    <Suspense fallback={<div className="py-8 text-sm text-gray-500">Loading results...</div>}>
      <SearchContent />
    </Suspense>
  );
}
    ...
    <div className="space-y-6">
      ...
      {!query ? (
        <div className="text-center py-16">
          ...
          <p className="text-gray-600 dark:text-gray-400">Enter a search term to find relevant news articles</p>
        </div>
      ) : (
